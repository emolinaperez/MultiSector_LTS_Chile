$title MODELO PMR (Version 1.1, SEPTIEMBRE 2020, Centro Energia Universidad de Chile)
...
set label_procesos /ID, ID_Sector, ID_Producto, Tipo, Capacidad_Instalada, Fplanta, Estado, Agno_ini, Agno_fin, Vutil, Zona, ID_Curva, ID_Tecnologia, ID_Ener, ID_Precio_energ, ConEsp, Cvar_no, Fcal, Fprecio, ID_Barra, Es_ERNC, ID_Zona_ERNC, Pmin, Regula, ConPropio, Inercia, Reserva_Primaria, Reserva_Secundaria,Impuesto, SPT, ID_Seg_Tran, Creditos /;
...
*calculo de precio de combustibles
