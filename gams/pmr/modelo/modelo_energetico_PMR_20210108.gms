...
*cargo datos tecnologias
set tec;
$call csv2gdx ../data_input/data_tecnologias.csv ID=test output=../data_input/data_tecnologias.gdx  Index=1 Values=2 UseHeader=Y StoreZero=Y
$gdxin ../data_input/data_tecnologias.gdx
$LOAD tec=Dim1
parameter data_id_tecnologias(tec)
$LOAD  data_id_tecnologias=test
$gdxin
*data_id_tecnologias;

*cargo datos potencial maximo por tecnologia
set tec2(tec);
$call csv2gdx ../data_input/data_potencial_maximo.csv ID=test output=../data_input/data_potencial_maximo.gdx  Index=1,2 Values=3 UseHeader=Y StoreZero=Y
$gdxin ../data_input/data_potencial_maximo.gdx
$LOAD tec2=Dim1
parameter data_potencial_maximo(tec2,t)
$LOAD  data_potencial_maximo=test
$gdxin
*display data_potencial_maximo;
...
Equation
    ...
    potencial_maximo(tec,t)                 'potencial maximo por tecnologia'
...
*potencial_maxima
potencial_maximo(tec2,t).. sum(i $((datos_procesos(i,"ID_Tecnologia")=data_id_tecnologias(tec2)) and (datos_procesos(i,"ID_sector")=id_generacion) and ord(t)>1),P(i,t)) =l=data_potencial_maximo(tec2,t);
...
costo_inversion_tx.. c_inversion_tx =e= sum((l,t)$(datos_lineas(l,"Estado") = 0), factor(t) * datos_lineas(l,"Inversion") * Instalar_LT(l,t)) ;
...
sol_potencia(s,i,t)=datos_procesos(i,"Capacidad_Instalada")$(datos_procesos(i,"Estado")=1 and agno(t)<=datos_procesos(i,"Agno_fin") and agno(t)>=datos_procesos(i,"Agno_ini"))+P.l(i,t)$(datos_procesos(i,"Estado")=0 or agno(t)>datos_procesos(i,"Agno_fin")); ;
...
put "costo_inversion_tx",",",(sum((l,t)$(datos_lineas(l,"Estado") = 0), factor(t) * datos_lineas(l,"Inversion") * Instalar_LT.l(l,t))) /
...
put "costo_inversion_tx",",",(sum((l,t)$(datos_lineas(l,"Estado") = 0),datos_lineas(l,"Inversion") * Instalar_LT.l(l,t))) /
...
loop(t,
put t.tl,",",sum((r,u),sol_emisiones_co2e(r,u,t)),",",sum((i,u),sol_emisiones_ge_co2e(i,u,t)),",",(sum((i,tt) $(ord(tt)>=ord(t) and (datos_procesos(i,"Estado")=0 or agno(t)>datos_procesos(i,"Agno_fin"))),1000*10**(-6)*(P.l(i,t)*cinv_a(i,t)$(agno(t)=tbase or rel_eq(agno(t),(datos_procesos(i,"Agno_fin")+1)))+(P.l(i,t)-P.l(i,t-1))*cinv_a(i,t)$(agno(t)>tbase and rel_ne(agno(t),(datos_procesos(i,"Agno_fin")+1)))))+sum((alm,tt) $(ord(tt)>=ord(t) and (datos_procesos(alm,"Estado")=0 or agno(t)>datos_procesos(alm,"Agno_fin"))),1000*10**(-6)*(datos_almacenamientos(alm)*P.l(alm,t)*cinv_alm_a(alm,t)$(ord(t)=1)+(P.l(alm,t)-P.l(alm,t-1))*datos_almacenamientos(alm)*cinv_alm_a(alm,t)$(ord(t)>1)))),",",sum(l$(datos_lineas(l,"Estado") = 0),datos_lineas(l,"Inversion")*Instalar_LT.l(l,t)),",",sum((i,tt) $(ord(tt)>=ord(t) and (datos_procesos(i,"Estado")=0 or agno(t)>datos_procesos(i,"Agno_fin"))),1000*10**(-6)*(P.l(i,t)*data_coma(i,t)$(agno(t)=tbase or rel_eq(agno(t),(datos_procesos(i,"Agno_fin")+1)))+(P.l(i,t)-P.l(i,t-1))*data_coma(i,t)$(agno(t)>tbase and rel_ne(agno(t),(datos_procesos(i,"Agno_fin")+1))))),",",sum(l$(datos_lineas(l,"Estado") = 0),datos_lineas(l,"COMA")*Instalar_LT.l(l,t)),",",(sum((r,k,j) $(datos_energeticos(j,"ID_Producto")=datos_productos(k,"ID") and datos_flujos(r,"ID_Producto")=datos_productos(k,"ID")),F.l(r,t)*datos_energeticos(j,"FConPr")*precio_energetico(r,t))*10**(-6)),",",(sum((i,j,m,b) $(datos_procesos(i,"ID_sector")=id_generacion and datos_procesos(i,"ID_Ener")=datos_energeticos(j,"ID")),Ge.l(i,t,m,b)*datos_procesos(i,"ConEsp")*datos_procesos(i,"Fprecio")*precio_energetico_ge(i,t)*data_duracion(t,m,b))*10**(-6)) /;
);
putclose;


parameters
costo_operacion_generacion_a(t)
coma_generacion_a(t)
costo_inversion_generacion_a(t)
costo_inversion_almac_a(t)
costo_inversion_trans(t)
costo_inversion_generacion(t)
costo_inversion_almac(t)
costo_inversion_trans(t)
;

*costos anualizados
costo_operacion_generacion_a(t)=(sum((i,j,m,b) $(datos_procesos(i,"ID_sector")=id_generacion and datos_procesos(i,"ID_Ener")=datos_energeticos(j,"ID")),Ge.l(i,t,m,b)*datos_procesos(i,"ConEsp")*datos_procesos(i,"Fprecio")*precio_energetico_ge(i,t)*data_duracion(t,m,b))*10**(-6));
coma_generacion_a(t)=sum((i,tt) $(datos_procesos(i,"ID_sector")=id_generacion and ord(tt)<=ord(t) and (datos_procesos(i,"Estado")=0 or agno(t)>datos_procesos(i,"Agno_fin"))),1000*10**(-6)*(P.l(i,tt)*data_coma(i,tt)$(agno(t)=tbase or rel_eq(agno(t),(datos_procesos(i,"Agno_fin")+1)))+(P.l(i,tt)-P.l(i,tt-1))*data_coma(i,tt)$(agno(t)>tbase and rel_ne(agno(t),(datos_procesos(i,"Agno_fin")+1)))));
costo_inversion_generacion_a(t)=(sum((i,tt) $(datos_procesos(i,"ID_sector")=id_generacion and ord(tt)<=ord(t) and (datos_procesos(i,"Estado")=0 or agno(t)>datos_procesos(i,"Agno_fin"))),1000*10**(-6)*(P.l(i,tt)*cinv_a(i,t)$(agno(t)=tbase or rel_eq(agno(t),(datos_procesos(i,"Agno_fin")+1)))+(P.l(i,tt)-P.l(i,tt-1))*cinv_a(i,tt)$(agno(t)>tbase and rel_ne(agno(t),(datos_procesos(i,"Agno_fin")+1)))))); 
costo_inversion_almac_a(t)=sum((alm,tt) $(ord(tt)<=ord(t) and (datos_procesos(alm,"Estado")=0 or agno(t)>datos_procesos(alm,"Agno_fin"))),1000*10**(-6)*(datos_almacenamientos(alm)*P.l(alm,tt)*cinv_alm_a(alm,tt)$(ord(t)=1)+(P.l(alm,tt)-P.l(alm,tt-1))*datos_almacenamientos(alm)*cinv_alm_a(alm,tt)$(ord(t)>1)));
costo_inversion_trans(t)=(sum(l$(datos_lineas(l,"Estado") = 0),datos_lineas(l,"Inversion") * Instalar_LT.l(l,t)));

costo_inversion_generacion(t)=sum(i $(datos_procesos(i,"ID_sector")=id_generacion and (datos_procesos(i,"Estado")=0 or agno(t)>datos_procesos(i,"Agno_fin"))),1000*10**(-6)*(P.l(i,t)*data_cinversion(i,t)$(agno(t)=tbase or rel_eq(agno(t),(datos_procesos(i,"Agno_fin")+1)))+(P.l(i,t)-P.l(i,t-1))*data_cinversion(i,t)$(agno(t)>tbase and rel_ne(agno(t),(datos_procesos(i,"Agno_fin")+1)))));
costo_inversion_almac(t)=sum(alm $(datos_procesos(alm,"Estado")=0 or agno(t)>datos_procesos(alm,"Agno_fin")),1000*10**(-6)*(datos_almacenamientos(alm)*P.l(alm,t)*data_cinversion_alm(alm,t)$(ord(t)=1)+(P.l(alm,t)-P.l(alm,t-1))*datos_almacenamientos(alm)*data_cinversion_alm(alm,t)$(ord(t)>1)));


File resultsBID / "../data_output/solution_generation_sector_anualizado.csv" /;
put resultsBID;
put "agno,emission,CAPEX,OPEX" /;
loop(t,
put t.tl,",",sum((i,u),sol_emisiones_ge_co2e(i,u,t)),",", (costo_inversion_generacion_a(t)+costo_inversion_almac_a(t)+costo_inversion_trans(t)),",",(costo_operacion_generacion_a(t)+coma_generacion_a(t))/;
);
putclose;

File resultsBID2 / "../data_output/solution_generation_sector.csv" /;
put resultsBID2;
put "agno,emission,CAPEX,OPEX" /;
loop(t,
put t.tl,",",sum((i,u),sol_emisiones_ge_co2e(i,u,t)),",", (costo_inversion_generacion(t)+costo_inversion_almac(t)+costo_inversion_trans(t)),",",(costo_operacion_generacion_a(t)+coma_generacion_a(t))/;
);
putclose;
