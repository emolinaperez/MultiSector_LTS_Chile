...
def sm_transport(df_in, odel_transport_pkm_aviation=None):
	...
	#summary
	# export emission
	dict_emission = {"transport_private": transport_emission_private,"transport_taxi": transport_emission_taxi, "transport_bus": transport_emission_bus,"transport_truck": transport_emission_truck,"transport_train": transport_emission_train,"transport_aviation": transport_emission_aviation,"transport_maritime": transport_emission_maritime}
	...
	for k in dict_emission.keys():
		...
		k_new = str(k).replace("transport_", "transport-") + "_emissions_mt_co2e"
		#add to output
	...
	#add totals
	dict_out.update({
		"transport-total_emissions_mt_co2e": vec_total_emissions,
		"transport-total_demand_electricity_gwh": vec_total_demand_electricity,
	})
